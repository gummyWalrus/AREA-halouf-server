...
__decorate([
    (0, mongoose_1.Prop)({ type: [{ type: mongoose_2.Types.ObjectId, ref: area_schema_1.Area.name }] }),
    (0, class_transformer_1.Type)(() => area_schema_1.Area),
