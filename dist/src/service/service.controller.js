...
let ServiceController = class ServiceController {
    ...
    async getServicesWithActions(req) {
        return await this.service.findActionServices(req);
    }
    async getServicesWithReactions(req) {
    ...
    async putService(id, updateServiceDto) {
...
], ServiceController.prototype, "getServicesWithActions", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ServiceController.prototype, "getServicesWithReactions", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(":id"),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ServiceController.prototype, "putService", null);
__decorate([
    (0, common_1.Delete)('all'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ServiceController.prototype, "deleteAll", null);
__decorate([
